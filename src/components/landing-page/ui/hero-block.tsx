...
const HeroBlock: React.FC = () => {
  return (
    <section className="relative font-semibold w-full  flex justify-center items-center p-4 overflow-hidden">
      <div className="relative w-full max-w-[1400px] h-auto rounded-[50px] bg-white p-7 flex flex-col items-center text-center">
        <HeroBackground />

        <h1
          className="text-[32px] leading-[100%] tracking-[-2%] text-black max-w-[1250px] z-[2] mt-[70px]
        ...
        <h5
          className="text-[18px] leading-[120%] tracking-[0%] text-black opacity-40 max-w-[1250px] mt-6 z-[2] 
        ...
        >
          ...
          Boost confidence, reduce returns, and elevate your e-commerce
          experience.
        </h5>

        <div className="mt-7 flex justify-center">
          <button
            className="flex items-center pl-5 pr-2 py-2 bg-[#8046FD] text-white rounded-full text-[16px] leading-[120%] z-[2] 
        md:text-base md:pl-4 md:pr-2 md:py-2 
        sm:text-[14px] sm:pl-3 sm:pr-1 sm:py-1"
          >
            Try It Now
            <span
              className="ml-3 w-9 h-9 bg-white rounded-full flex items-center justify-center 
    md:w-8 md:h-8 sm:w-7 sm:h-7"
        ...
        <div className="mt-[30px] flex justify-center w-full z-[2]">
          <Hero className="max-w-full sm:max-w-[1250px] " />
        </div>
      </div>
    </section>
  );
